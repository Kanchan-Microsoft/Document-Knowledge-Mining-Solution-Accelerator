        ...
        this IEndpointRouteBuilder builder, string apiPrefix = "/", IEndpointFilter? authFilter = null)
    {
        ...
        var route = group.MapDelete(Constants.HttpIndexesEndpoint,
                async Task<IResult> (
                    ...
                    CancellationToken cancellationToken) =>
                {
                    log.LogTrace("New delete document HTTP request, index '{0}'", index.Replace("\r", string.Empty).Replace("\n", string.Empty));
        ...
        this IEndpointRouteBuilder builder, string apiPrefix = "/", IEndpointFilter? authFilter = null)
    {
        ...
        var route = group.MapPost(Constants.HttpAskEndpoint,
                    ...
                    CancellationToken cancellationToken) =>
                {
                    ...
                    log.LogTrace("New search request, index '{0}', minRelevance {1}", query.Index.Replace("\r", string.Empty).Replace("\n", string.Empty), query.MinRelevance);
        ...
        this IEndpointRouteBuilder builder, string apiPrefix = "/", IEndpointFilter? authFilter = null)
    {
        ...
        var route = group.MapPost(Constants.HttpSearchEndpoint,
                    ...
                    CancellationToken cancellationToken) =>
                {
                    ...
                    log.LogTrace("New search HTTP request, index '{0}', minRelevance {1}", query.Index.Replace("\r", string.Empty).Replace("\n", string.Empty), query.MinRelevance);
    ...
    public static void AddGetDownloadEndpoint(this IEndpointRouteBuilder builder, string apiPrefix = "/", IEndpointFilter? authFilter = null)
    {
        ...
        var route = group.MapGet(Constants.HttpDownloadEndpoint, async Task<IResult> (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                log.LogTrace("New download file HTTP request, index {0}, documentId {1}, fileName {3}", index.Replace("\r", string.Empty).Replace("\n", string.Empty), documentId.Replace("\r", string.Empty).Replace("\n", string.Empty), filename.Replace("\r", string.Empty).Replace("\n", string.Empty));
                ...
                try
                {
                    ...
                    log.LogTrace("Downloading file '{0}', size '{1}', type '{2}'", filename.Replace("\r", string.Empty).Replace("\n", string.Empty), file.FileSize, file.FileType);
